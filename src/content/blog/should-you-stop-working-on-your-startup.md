...
description: "This is the toughest question founders face, and given the current funding environment, I get it a lot. When I was a founder, I never had a good way to think about"
pubDate: 2025-11-06
---

This is the toughest question founders face, and given the current funding environment, I get it a lot.
...
If the answer is yes to any of these questions, continue working on your startup but focus on that step.
...
Action generates information. Promising experiments generate learnings that lead to growth.

## 4. Conviction

If you're not growing or learning quickly, and short on promising experiment ideas, ask yourself if you still believe in what you're doing.
...
If you stop working on your startup, you've decided to (1) work on a new problem or (2) stop completely.
...
1. **Obligation** – If you have investors, you might feel like you've let them down. You haven't. When Iterative invests in a founder, we expect you to put a good faith effort into your startup. You can't guarantee success, and I don't expect you to. I've been a founder long enough to know that's impossible. We're betting on your startup, just like you are, and when it doesn't work out, we're wrong too.
...
When you're ready, [apply to Iterative](http://iterative.vc/apply). We like founders who have failed before. As I often say, the best advice for first-time founders is to be a second-time founder.
